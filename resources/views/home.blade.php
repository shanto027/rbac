      ...
      <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6 col-12 dashboard-greetings">
              <div class="card">
                  <div class="card-header">
                  <h3 class="greeting-text">Total Customer</h3>
                  <p class="mb-0"></p>
                  </div>
                  <div class="card-body pt-0">
                  <div class="d-flex justify-content-between align-items-end">
                      <div class="dashboard-content-left">
                      <h1 class="text-primary font-large-2 text-bold-500">15</h1>
                      <p></p>
                      <button type="button" class="btn btn-primary glow">View </button>
                      </div>
                      <!-- <div class="dashboard-content-right">
            ...
            <div class="col-xl-3 col-md-6 col-12 dashboard-greetings">
              <div class="card">
                  <div class="card-header">
                  <h3 class="greeting-text">Today's Visitors</h3>
                  <p class="mb-0"></p>
                  </div>
                  <div class="card-body pt-0">
                  <div class="d-flex justify-content-between align-items-end">
                      <div class="dashboard-content-left">
                      <h1 class="text-primary font-large-2 text-bold-500">50</h1>
                      <p></p>
                      <button type="button" class="btn btn-primary glow">View </button>
                      </div>
                      <!-- <div class="dashboard-content-right">
